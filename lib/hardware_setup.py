...
# GPIO pin  Meaning
# IO16      Operate current control
# IO17      Decrease value of current control
# IO18      Select previous control
# IO19      Select next control
# IO20      Increase value of current control
...
display = Display(ssd, nxt, sel, prev, False, None, 4)  # Encoder only mode